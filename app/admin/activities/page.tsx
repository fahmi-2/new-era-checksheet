...
export default function StatusGA() {
  ...
  return (
    <div className="app-page">
      ...
      <style jsx>{`
        /* ── Base Layout - Responsive dengan Sidebar ── */
        .page-content {
          flex: 1;
          margin-left: 75px; /* Sidebar collapsed */
          padding: 24px;
          min-height: 100vh;
          background: #f7f9fc;
        ...
        :global(.sidebar-expanded) ~ .page-content {
          margin-left: 280px;
        }
        ...
        .ga-notice-content strong { 
          display: block; 
          font-size: 1rem; 
          margin-bottom: 0.25rem; 
        }
        .ga-notice-warning .ga-notice-content strong { 
          color: #c2410c; 
        }
        .ga-notice-info .ga-notice-content strong { 
          color: #1d4ed8; 
        }
        .ga-notice-content p { 
          margin: 0; 
        ...
        .ga-notice-warning .ga-notice-content p { 
          color: #9a3412; 
        }
        .ga-notice-info .ga-notice-content p { 
          color: #1e40af; 
        }
        ...
        .ga-permitted-item strong { 
          display: block; 
          font-size: 0.85rem; 
          color: #0f172a; 
        }
        .ga-permitted-item small { 
          font-size: 0.75rem; 
          color: #64748b; 
        }
        ...
        .ga-check-card:hover .ga-card-icon { 
          border-color: #3b82f6; 
          background: #eff6ff; 
        }
        .ga-card-copy { 
        ...
        .ga-check-card:hover .ga-card-copy h3 {
          color: #2563eb;
        }
        .ga-card-copy p { 
          font-size: 0.8rem; 
        ...
        .ga-check-card:hover .ga-card-arrow { 
          color: #3b82f6; 
